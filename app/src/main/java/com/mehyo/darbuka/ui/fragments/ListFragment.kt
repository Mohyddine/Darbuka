...
import com.mehyo.darbuka.databinding.FragmentListBinding
...
class ListFragment : Fragment(), OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val reposAdapter = ReposAdapter(this@ListFragment)
        ...
        binding.apply {
            ...
            myViewModel.repos.observe(viewLifecycleOwner, { result ->
                reposAdapter.submitList(result.data)
                pbList.isVisible = result is Resource.Loading && result.data.isNullOrEmpty()
    ...
    override fun onItemClicked(id: Int) {
        findNavController().navigate(ListFragmentDirections.actionListFragmentToDetailsFragment(id))
    }
}